    ...
    <div style={{ paddingBottom: isMobile ? '80px' : '0' }}>
      ...
      {!isMobile && (
        <header className="flex-between" style={{ marginBottom: '2rem' }}>
          ...
          <button className="primary-button" style={{ background: '#3742fa', color: 'white', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
      ...
      {isMobile && (
        <div style={{ padding: '1rem', background: '#050505', color: '#FFF' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
            ...
            <button style={{ background: '#111', color: '#FFF', border: '1px solid #2A2A2A', padding: '0.5rem 1rem', borderRadius: '8px', display: 'flex', alignItems: 'center', gap: '0.5rem', fontSize: '0.8rem', fontWeight: 700 }}>
        ...
        <div style={{ padding: '1rem', display: 'flex', flexDirection: 'column', gap: '1rem', background: '#050505', minHeight: '100vh' }}>
          ...
          <div>
             <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem', marginTop: '0.5rem' }}>
               ...
               <button style={{ background: 'none', border: 'none', color: '#3742fa', fontSize: '0.8rem', fontWeight: 700, display: 'flex', alignItems: 'center', gap: '0.2rem' }}>View All <ArrowRight size={12} /></button>
             </div>
